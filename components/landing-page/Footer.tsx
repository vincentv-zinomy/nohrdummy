        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
          ...
          <div>
            ...
            <button
              type="submit"
              id="email"
              className="w-full md:w-40 text-center text-sm md:text-base font-semibold bg-rose-500 rounded-xl hover:opacity-80 hover:text-brand-green py-3 px-9 mt-3 md:mt-6"
            >
              Subscribe
            </button>
          </div>
