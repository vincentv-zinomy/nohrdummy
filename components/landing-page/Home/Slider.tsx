...
const testimonials = [

  {
    ...
    rating: 5,
    testimonial:
      " We have practically eliminated the role involved in co-ordinating with the leads. Saving a lot of man-hours! ",
    profile: profilepic2
  },
  {
    name: "Tom S",
    ...
    rating: 5,
    testimonial:
      "This is the best solution for a small / medium sized company like ours, we no longer need to hire an expensive full-time resource for the lead out-reach task.",
    profile: profilepic3
  },
  {
    name: "Caleb",
