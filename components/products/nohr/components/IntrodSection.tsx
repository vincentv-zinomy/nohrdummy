...
import ImgHello from "../assets/IntrodSection/img-hello.svg";
import IconGreenTitle from "../assets/IntrodSection/icon-green-title.svg";
import IconPlay from "../assets/IntrodSection/icon-play.svg";
import IconLine from "../assets/IntrodSection/icon-line.svg";
import { useRouter } from "next/navigation";
import posthog from 'posthog-js';
import { useRef, useState } from "react";
import thumbnailImage from '../assets/IntrodSection/thumbnail.jpeg'
