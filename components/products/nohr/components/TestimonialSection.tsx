...
import IconGreenTitle from "../assets/TestimonialSection/icon-green-title.svg"; 
import IconQuoteBottom from "../assets/TestimonialSection/icon-quote-bottom.svg";
import IconQuoteTop from "../assets/TestimonialSection/icon-quote-top.svg";
import IconArrowLeft from "../assets/TestimonialSection/icon-arrow-left.svg";
import IconArrowRight from "../assets/TestimonialSection/icon-arrow-right.svg";
import IconStar from "../assets/TestimonialSection/icon-start.svg"; 
