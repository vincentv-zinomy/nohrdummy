  ...
  return (
    <div className="flex items-center justify-between bg-white border-b border-slate-200 px-4 sm:px-6 md:px-5 h-16 shrink-0">
      ...
      <div className="flex items-center">
        ...
        <div className="flex  gap-4 items-center ">
          <a
            ...
            href="#0"
          >
            <span className="uppercase font-semibold">{currentContact && currentContact.full_name && currentContact.full_name[0] ? currentContact.full_name[0] : ``}</span>
          </a>
      ...
      <div className="flex">
        ...
        {
          messages && messages.data && messages.data[messages.data.length - 1]?.admin_read_message &&
          <button
            className="p-1.5 shrink-0 rounded border border-slate-200 hover:border-slate-300 shadow-sm ml-2"
            aria-label="mark as read"
          >
