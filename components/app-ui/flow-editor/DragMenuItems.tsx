...
const DragMenuItems = ({ item }: Props) => {
  ...
  return (
    <div>
        ...
        key={item.name}
        className={
            "w-full flex items-center justify-between px-2 py-2 text-sm border-b border-slate-300 bg-slate-100  "
        }
        ...
        <div className={`${open ? 'h-fit opacity-1' : 'h-0 opacity-0'}     w-full `}>
