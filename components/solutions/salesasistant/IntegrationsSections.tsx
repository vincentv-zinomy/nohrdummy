...
{" "}
          ...
          <p className="md:text-lg text-brand-gray-300 mt-3">
            {" "}
            Worried about fitting Zigment into your stack? Don't. We play nice with most of the engagement channels—Instagram, FB, SMS, WhatsApp, you name it. Plus, we're buds with your existing CRMs like Zoho, Salesforce, and Hubspot.
          </p>
        </div>
            <div>
