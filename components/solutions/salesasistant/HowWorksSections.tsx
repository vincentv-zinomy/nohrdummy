...
const worksteps = [
    {
        name:'Quick Setup',
        description:"Just a few clicks and you're good to go."
    },
    {
        name:'Customization',
        description:"Tell Zigment what you want to say and how you want to say it. "
    },
    {
        name:'Engage and Relax',
        description:"Watch your community grow while you focus on what you're best at."
    },
]
